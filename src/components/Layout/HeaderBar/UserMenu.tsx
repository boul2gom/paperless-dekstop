...
export const UserMenu: React.FC<UserProperties> = ({name, image}) => {
    ...
    return (
        ...
        >
            ...
            <Menu.Dropdown>
                ...
                <Menu.Item
                    leftSection={
                        <IconPhoto style={{width: rem(16), height: rem(16)}} color={theme.colors.green[6]}
                                   stroke={1.5}/>
                    }
                > Photos
                </Menu.Item>
                <Menu.Item
                    leftSection={
                        <IconFileTypePdf style={{width: rem(16), height: rem(16)}} color={theme.colors.orange[6]}
                                         stroke={1.5}/>
                    }
                > Documents
                </Menu.Item>
                <Menu.Item
                    leftSection={
                        <IconFolderSearch style={{width: rem(16), height: rem(16)}} color={theme.colors.blue[6]}
                                          stroke={1.5}/>
                    }
                > All documents
                </Menu.Item>
